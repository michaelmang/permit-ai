...
export function buildDisclosureBadgeSvg(payload, rid) {
  ...
  <rect x="1" y="1" width="${width - 2}" height="${height - 2}" rx="7" fill="${COLORS.white}"></rect>
  <rect x="0.5" y="0.5" width="${width - 1}" height="${height - 1}" rx="8" fill="none" stroke="${COLORS.border}" stroke-width="1"></rect>
  ${textMarkup}
</svg>`;
}
